...
// Naive histogram (generates wrong output because of race condition)
__global__ void naive_histogram(int *d_bins, const int *d_in, const int BIN_COUNT){
...
int main(int argc, char **argv){
    ...
    naive_histogram<<<threads, blocks>>>(d_bins, d_in, BIN_COUNT);
